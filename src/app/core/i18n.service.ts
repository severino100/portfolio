...
export interface I18nData {
  ...
  about: { num: string; label: string; title: string; p1: string; p2: string; p3: string; portraitMeta: string[]; facts: [string, string][] };
  interlude: { pre: string; quote: string; sig: string };
  work: { num: string; label: string; title: string; hint: string };
  projects: { num: string; label: string; title: string; hint: string };
  life: { num: string; label: string; title: string; hobbiesLabel: string; academyLabel: string };
  skills: { num: string; label: string; title: string; languages: string };
...
const EN: I18nData = {
  ...
  hero: {
    portfolio: 'Portfolio  /  2026', available: '● Available for collaboration', location: 'Sintra · Lisbon, PT',
  ...
  work: { num: '03', label: 'Selected Work', title: 'Eleven years of <em>shipping</em> &mdash; one timeline.', hint: '↓ Click a card to reveal the projects, clients & stack.' },
  projects: { num: '04', label: 'Personal Projects', title: 'Side&nbsp;quests &mdash; what I build when <em>nobody\'s watching</em>.', hint: 'Personal builds, school work & one mobile game still in pocket.' },
  life: { num: '05', label: 'Life & Schooling', title: 'Where I <em>studied</em>, what I do when I\'m <em>not at the keyboard</em>.', hobbiesLabel: 'Off-screen', academyLabel: 'Academy' },
  skills: { num: '06', label: 'Skills', title: 'The toolkit, <em>honestly</em> rated.', languages: 'Languages' },
  foot: { pre: 'Get in touch', big: 'Let\'s talk.', meta: ['© 2026 Ruben Severino', 'Cacém · Sintra · Lisbon, PT', 'Built in Angular\'s spare time'] },
};

const PT: I18nData = {
  nav: { about: 'Sobre', work: 'Carreira', projects: 'Projetos', life: 'Vida', skills: 'Skills', contact: 'Contacto' },
  hero: {
    portfolio: 'Portfólio  /  2026', available: '● Disponível para colaborar', location: 'Sintra · Lisboa, PT',
  ...
  work: { num: '03', label: 'Carreira', title: 'Onze anos de <em>entregas</em> &mdash; uma só timeline.', hint: '↓ Clica num cartão para ver os projetos, clientes e stack.' },
  projects: { num: '04', label: 'Projetos Pessoais', title: 'Side&nbsp;quests &mdash; o que construo quando <em>ninguém está a ver</em>.', hint: 'Projetos pessoais, trabalhos académicos e um jogo de telemóvel ainda em bolso.' },
  life: { num: '05', label: 'Vida & Formação', title: 'Onde <em>estudei</em> e o que faço quando <em>não estou no teclado</em>.', hobbiesLabel: 'Fora do ecrã', academyLabel: 'Formação' },
  skills: { num: '06', label: 'Skills', title: 'A caixa de ferramentas, <em>honestamente</em> avaliada.', languages: 'Idiomas' },
  foot: { pre: 'Falar comigo', big: 'Vamos conversar.', meta: ['© 2026 Ruben Severino', 'Cacém · Sintra · Lisboa, PT', 'Feito nos tempos livres do Angular'] },
};
